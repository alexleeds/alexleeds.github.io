...
This sounds a lot like a political campaign in denial about the polls. Coinbase, Dixon's greatest success in this arena, belongs to "the culture of the casino." 
...
Great NYC companies like [Ava Labs](https://www.avalabs.org/) that theoretically provide a platform for decentralized applications are - actually and necessarily - touting their applications like "an NFT and crypto wallet extension" and an "asset wallet." Though NFTs have gone the way of [tulips](https://en.wikipedia.org/wiki/Tulip_mania) (see [The Broke Ape Yacht Crash](https://www.coindesk.com/consensus-magazine/2023/07/05/the-broke-ape-yacht-crash-lessons-for-justin-bieber-and-other-nft-collectors/)).

As of May 2024, the value of the cash in cryptocurrencies was estimated to be /$2.5 trillion. That is an attractive number. But break it down and we see: "1. Bitcoin (BTC) · $1.21 trillion ; 2. Ethereum (ETH) · $369 billion ; 3. Tether (USDT) · $110 billion ; 4. BNB (BNB) · $85 billion..." The dollars are crowding into Bitcoin, the first-generation blockchain product with the least utility, because pure speculation is the primary game.
...
Chris still raised a $4.5B crypto fund in 2022. I'll be extremely curious to see how that plays out.