...
These are all standard, but there are four steps that take a concerted effort to really excel at these techniques:

**(1) Gather this data on a regular cadence.**

Certain “slow” measurements (e.g. interviews) might happen twice a year. Certain fast measurements might happen every hour. But it is important to have predictability in these feedback loops so that people embed the information in their operations. These need to be really smooth: the data should be at teams' fingertips when they need it, if not automating tactics directly.

**(2) Capture the same data about your target markets and your existing customers.**

Organizations tend to research the their own customers or the market, but they rare collect the *same exact* metrics for representative samples of both.

With data about your target markets and your existing customers, you get obvious charts that look like this:

![](market_map1.png)

The same chart of Penetration vs. Promise be produced for **verticals** *or* **interest in product features** *or* **geographic regions** *or* **media audience** and it can be modified to reflect cost to acquire a customer instead of scale.

**Promise** can be modified to reflect achievable market value rather than customer count, of course. And **Penetration** can be explored on its own through a chart that shows the % of highly likely customers in each vertical vs. the % of customers in each vertical who know about you (or prefer you).
...
A strong signal of Apple Vision Pro's promise is that people say they love using it for two specific activities: watching movies and reading email. 

Facebook burnt billions of dollars trying to get people to do new things with Quest headsets, exploring their metaverse or playing new games. Meanwhile, Apple seems to have triumphed by producing a device that improves everyday lives. If everyday Americans will dump money on a home theater system, it isn’t such a stretch for them to buy the Vision Pro to make the same experience better.

Once people adopt the Apple Vision Pro for movies, or sports watching, or email, then the gateway opens to create new experiences. The same is true for growth feedback which can grow from optimization to real innovation.