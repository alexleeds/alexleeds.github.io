...
The same chart of *penetration* vs. *promise* can be produced for **verticals** *or* **interest in product features** *or* **geographic regions** *or* **media audience** and it can be modified to consider marketing efficacy (CAC/LTV) in place of promise or scale.

Meanwhile, **penetration** can be explored on its own through a chart that shows the % of highly likely customers in each vertical vs. the % of customers in each vertical who know about you (or prefer you).
