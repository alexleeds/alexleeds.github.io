...
I'm a data scientist who predicts (and sometimes designs) consumer behavior. I use a mix of experiments, human feedback, and computationally intensive methods to refine ads, pricing, monetization, market segmentation, and product/feature selection.
...
In my free time, I enjoy reading biographies, swimming (badly), and [coding projects for pure entertainment](/projects/). I also created and (lightly) oversee a meetup called [NYC AI Hackers](https://www.meetup.com/ai-hackers/) that runs events exploring data science and AI applications.
