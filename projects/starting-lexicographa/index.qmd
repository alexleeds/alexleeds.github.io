...
I'm exploring methods for systematically discovering words in other languages for concepts we don't have in English. These are both fun and useful, but mostly just fun. [For instance](https://ihworld.com/news-blog/ih-blog/10-words-that-don-t-exist-in-english/): 

*Abbiocco* (in Italian, the sleepy feeling after eating a large meal), [*verschlimbessern*](https://germanyinusa.com/2020/01/24/word-of-the-week-verschlimmbessern/) (in German, to make something worse in a well-meaning attempt to make it better), *dépaysement* (in French, the mix of euphoria and disorientation of being in a foreign country), etc. 
...
The supervised method begins with a [list of words that fit my objective](https://ihworld.com/news-blog/ih-blog/10-words-that-don-t-exist-in-english/, and then analyzes the conditions that make hundreds of these words interesting in order to uncover new ones. 
