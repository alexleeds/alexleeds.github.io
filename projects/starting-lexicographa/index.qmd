...
I'm exploring methods for systematically discovering words in other languages for concepts we don't have in English. These are both fun and useful, but mostly just fun. For instance: 
...
There are two ways to go about the problem of finding useful words outside English, basically unsupervised and supervised learning in the discipline of machine learning:

### Far out or *far out, man*?
